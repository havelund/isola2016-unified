...
A formalism must support definition of Domain-Specific 
Languages (DSLs). A key to modeling and programming is to capture 
...
ease looking at a two-dimensional illustration when they encounter a 
...
approach than the text-based source code repositories often used by
