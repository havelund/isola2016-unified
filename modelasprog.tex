...
%
Attempts have been made to provide textual versions of UML and SysML diagrams. An example is  the K specification language \cite{?}, that was developed at JPL. The \name{Book} class with the added constraint can be expressed in K as shown in Figure 
