...
%\newcommand{\enclose}[1]{`#1'}
%\newcommand{\enclose}[1]{$\langle$#1$\rangle$}
%\newcommand{\enclose}[1]{[#1]}
%\newcommand{\enclose}[1]{$\mid$#1$\mid$}
%\newcommand{\enclose}[1]{$\lceil$#1$\rceil$}
\newcommand{\enclose}[1]{$\lfloor$#1$\rfloor$}
...
\newcommand{\iscala}[1]{\enclose{\scala\lstinline{#1}}}
...
\newcommand{\iocl}[1]{\enclose{\oclinecore\lstinline{#1}}}

\newcommand{\zlang}{\lstset{language=zlang,backgroundcolor=\color{white}, frame=none,basicstyle={\small}}}
\newcommand{\izlang}[1]{\enclose{\zlang\lstinline{#1}}}

\newcommand{\klang}{\lstset{language=klang,backgroundcolor=\color{white}, frame=none,basicstyle={\small}}}

\newcommand{\vdm}{\lstset{language=vdm,backgroundcolor=\color{white}, frame=none,basicstyle={\small}}}
\newcommand{\ivdm}[1]{\enclose{\vdm\lstinline{#1}}}
