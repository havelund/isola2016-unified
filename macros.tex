...
\lstdefinelanguage{oclinecore}{
  morekeywords=
    {class,invariant,self,attribute,property,derived,derivation,operation,body}, 
  literate=
      {->}{{$\rightarrow\;$}}2
      {<=}{{$\le$}}2
  ,
...
\newcommand{\scala}{\lstset{language=scala,backgroundcolor=\color{white}, frame=none,basicstyle={\small},frame=single}}

\newcommand{\scalaimpl}{\lstset{language=scala,backgroundcolor=\color{light-gray}, frame=none,basicstyle={\small},frame=single}}
